...
\href{https://wayve.ai}{\textbf{San Francisco Bay Area}}       \hfill   \textbf{Technical Lead, Senior Staff Engineer}
   ...
   \begin{itemize}
   {\item[$\checkmark$] Helped develop Wayve's simulation strategy cross-team and with leadership}
   {\item[$\checkmark$] Collaborated on Verification and Release approaches (e.g.\ HIL validation, virtual ECUs)}
