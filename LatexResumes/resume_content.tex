...
\textbullet~Systems Software & \textbullet~Near Field Communications
\end{tabular}
\end{table}
...
\href{http://www.markovcorp.com}{\textbf{Palo Alto, California}}       \hfill   \textbf{Founder, CTO}
   ...
   \item Co-founded company in my garage, and was interim CEO until Series-A funding in October 2016
   \item Invented (patent-pending) algorithms that are at the heart of our products
   \item Led and ran the AI team responsible for machine learning, computer vision, sensing and planning
   \item Responsible for R\&D, software and systems engineering
%   \begin{itemize}
%   \item[$\checkmark$]
