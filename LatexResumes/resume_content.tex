...
\center{Engineering leader who loves building game-changing products and strong teams}
}{}
...
\href{http://www.markovcorp.com}{\textbf{Palo Alto, California}}       \hfill   \textbf{Founder, CTO}
   ...
   \item We raised 25 million in 2 rounds (Series A and B)
   \item Invented algorithms that are at the heart of our products
   \item Helped build our engineering team,  for machine learning, computer vision, sensing and planning
   ...
   \item More of a player/coach - managing teams, chief architect, code-reviews, while also being hands-on
%   \begin{itemize}
%   \item[$\checkmark$]
%   Built a proof-of-concept prototype in a month
...
\vspace{8pt}
\begin{itemize}
\item Markov - Technical co-founder of Markov Corporation (Level.ai), and led engineering and R\&D.
